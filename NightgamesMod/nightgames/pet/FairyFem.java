...
public class FairyFem extends Pet {
    ...
    public void caught(Combat c, Character captor) {
        if (captor.human()) {
            ...
            c.write(captor, Formatter.format("{other:SUBJECT-ACTION:manage|manages} to catch {self:name-do} and starts pleasuring her with the tip of {other:possessive} finger. The sensitive fae clings to the probing finger desperately as she thrashes "
    ...
    protected void buildSelf() {
        ...
        PetCharacter self = new PetCharacter(this, owner().nameOrPossessivePronoun() + " " + getName(), owner.getType().toString() + ": " + getName(), growth, getPower());
