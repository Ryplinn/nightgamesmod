...
public class ParasitedMod extends PartMod {
    ...
    public double applyReceiveBonuses(Combat c, Character self, Character opponent, BodyPart part, BodyPart target, double damage) {
        c.write(self, Formatter.format("The parasite inhabiting {self:name-possessive} %s is making {self:direct-object} <b>extremely sensitive</b>.", self, opponent, part.getType()));
        return 10;
    }
