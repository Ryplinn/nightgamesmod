...
public class Threesomes extends DaytimeEvent {
    ...
    Threesomes(Character player) {
        super();
        if (GameState.getGameState().characterPool.getNPC("Cassie")
                  .getAffection(player) >= 20
                        && GameState.getGameState().characterPool.getNPC("Jewel")
                                 .getAffection(player) >= 20
                        && GameState.getGameState().characterPool.getNPC("Jewel")
                                 .getAffection(GameState.getGameState().characterPool.getNPC("Cassie")) >= 5) {
                        //TODO && GameState.getValue(Flag.CassieDWV) >= 5) {
            register("CassieJewel", 5);
        }
        if (GameState.getGameState().characterPool.getNPC("Mara")
                  .getAffection(player) >= 20
                        && GameState.getGameState().characterPool.getNPC("Jewel")
                                 .getAffection(player) >= 20
                        && GameState.getGameState().characterPool.getNPC("Jewel")
                                 .getAffection(GameState.getGameState().characterPool.getNPC("Mara")) >= 5) {
            register("MaraJewel", 5);
        }
        if (GameState.getGameState().characterPool.getNPC("Mara")
                  .getAffection(player) >= 15
                        && GameState.getGameState().characterPool.getNPC("Angel")
                                 .getAffection(player) >= 15
                        && GameState.getGameState().characterPool.getNPC("Angel")
                                 .getAffection(GameState.getGameState().characterPool.getNPC("Mara")) >= 10) {
            register("AngelMara", 5);
        }
        if (GameState.getGameState().characterPool.getNPC("Mara")
                  .getAffection(player) >= 15
                        && GameState.getGameState().characterPool.getNPC("Cassie")
                                 .getAffection(player) >= 15
                        && GameState.getGameState().characterPool.getNPC("Cassie")
                                 .getAffection(GameState.getGameState().characterPool.getNPC("Mara")) >= 10) {
            ...
            case "CassieJewel":
                GUI.gui
                      .message("You step out of the shower room with a towel wrapped around your waist to preserve your modesty. One of these days you should get a proper bathrobe, "
                                      ...
                                      + "what this accomplishes. It's not like " + getPlayer().getTrueName()
                                      ...
                                      + getPlayer().getTrueName() + " like this is because "
                                      ...
                                      + "here. Get a good grip on " + getPlayer().getTrueName()
                                      ...
                                      + getPlayer().getTrueName() + " to pay attention to me "
                                      ...
                                      + getPlayer().getTrueName() + " is very good with his tongue, I can personally vouch "
            ...
            case "MaraJewel":
                GUI.gui
                      .message("You're sitting in your room, working on some homework, when you hear a knock on your door. You open the door to find Mara, who pushes past you into "
                                      ...
                                      + getPlayer().getTrueName() + ". I just wish I was a "
